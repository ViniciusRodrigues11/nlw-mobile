...
export default function OrphanageDetails({ theme }: OrphanageDetailsProps) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={theme == 'light' ? styles.mapContainer : styles.mapContainerDark}>
          <MapView
          ...
          <TouchableOpacity style={styles.routesContainer} onPress={handleOpenGoogleMap}>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue, theme == 'dark' && {backgroundColor: '#1a1a2e'} ]}>
            <Feather name="clock" size={40} color="#2AB5D1"  />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue,]}>Segunda à Sexta {orphanage.opening_hours}</Text>
          </View>
          {orphanage.open_on_weekends ? (
            <View style={[styles.scheduleItem, styles.scheduleItemGreen, theme == 'dark' && {backgroundColor: '#1a1a2e'}]}>
              <Feather name="info" size={40} color="#39CC83" />
              <Text style={[styles.scheduleText, styles.scheduleTextGreen]}>Atendemos fim de semana</Text>
            </View>
          ) : <View style={[styles.scheduleItem, styles.scheduleItemRed, theme == 'dark' && {backgroundColor: '#1a1a2e'}]}>
